		...
		<div className={columnStyles.container}>
			<StrictModeDroppable
				children={(provided, snapshot) => (
					<div ref={provided.innerRef} {...provided.droppableProps} className={columnStyles.wraper}>
						<ColumnHeader id={el.id} title={el.title} cardsLength={el.cards.length} />
						{el.cards.map((el, i) => {
							return <Card el={el} key={el.content + el.id} openModal={props.openModal} />;
						})}
